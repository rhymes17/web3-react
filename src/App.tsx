...
function App() {
  ...
  return (
    <div className="w-[100%] bg-[#0A0A0F] h-[100vh] flex justify-center items-center">
      <div className="w-[45%] relative flex flex-col gap-8 bg-[#1A1C28] rounded-[2rem] h-[90vh] shadow-2xl border-[0.05rem] border-gray-300/20 mx-auto py-5 px-5 text-white">
          <Header />
